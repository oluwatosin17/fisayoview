      ...
      >
        ...
        <div className="flex flex-col items-center gap-4 mb-8">
          <div
            ...
            style={{ background: "#fff", width: 52, height: 52 }}
          >
            <Image
              src="/logo-black.png"
              alt="FV"
        ...
        {status === "success" ? (
          <div className="text-center py-4">
            ...
            <p className="text-sm" style={{ color: "#808080" }}>
              We sent a magic link to <strong style={{ color: "#fff" }}>{email}</strong>. Click it
              to sign in.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              ...
              className="w-full rounded-lg py-3 text-sm font-semibold transition-opacity cursor-pointer"
              style={{
                background: "#fff",
                color: "#000",
